...
const dict = {
  ...
  "portal.btnRefresh":         { es: "↻ Actualizar datos",          en: "↻ Refresh data",           id: "↻ Perbarui data",              fr: "↻ Actualiser les données" },
  "portal.confirmRefresh":     { es: "¿Actualizar desde las marcaciones? Los cambios manuales no guardados se perderán.", en: "Refresh from attendance records? Unsaved manual changes will be lost.", id: "Perbarui dari data absensi? Perubahan manual yang belum disimpan akan hilang.", fr: "Actualiser depuis les pointages ? Les modifications manuelles non enregistrées seront perdues." },
  "portal.refreshing":         { es: "Actualizando…",               en: "Refreshing…",              id: "Memperbarui…",                 fr: "Actualisation…" },
  "portal.refreshed":          { es: "✓ Datos actualizados",        en: "✓ Data refreshed",         id: "✓ Data diperbarui",            fr: "✓ Données actualisées" },
