...
const dict = {
  ...
  "dash.emp.btnRename":    { es: "Cambiar nombre", en: "Rename", id: "Ubah nama" },
  "dash.emp.promptRename": { es: "Nuevo nombre completo:", en: "New full name:", id: "Nama lengkap baru:" },
  "dash.emp.errRename":    { es: "No se pudo cambiar el nombre: {msg}", en: "Couldn't rename: {msg}", id: "Gagal mengubah nama: {msg}" },
  ...
  "dash.navOvertime":             { es: "Horas extras",          en: "Overtime",            id: "Lembur" },
  "dash.ot.title":                { es: "Horas extras",          en: "Overtime",            id: "Lembur" },
  "dash.ot.hint":                 { es: "Formularios de horas extras enviados por los empleados. Añade los nombres de quien autoriza y aprueba antes de imprimir.", en: "Overtime forms submitted by employees. Add the names of the authorizer and approver before printing.", id: "Formulir lembur yang dikirimkan karyawan. Tambahkan nama pemberi izin dan penyetuju sebelum mencetak." },
  "dash.ot.filterAll":            { es: "Todos",                 en: "All",                 id: "Semua" },
  "dash.ot.filterSubmitted":      { es: "Enviados",              en: "Submitted",           id: "Terkirim" },
  "dash.ot.filterApproved":       { es: "Aprobados",             en: "Approved",            id: "Disetujui" },
  "dash.ot.filterRejected":       { es: "Rechazados",            en: "Rejected",            id: "Ditolak" },
  "dash.ot.filterDraft":          { es: "Borradores",            en: "Drafts",              id: "Draf" },
  "dash.ot.filterAllMonths":      { es: "Todos los meses",       en: "All months",          id: "Semua bulan" },
  "dash.ot.none":                 { es: "No hay formularios con estos filtros.",  en: "No forms match these filters.", id: "Tidak ada formulir yang cocok." },
  "dash.ot.statusSubmitted":      { es: "Enviado",               en: "Submitted",           id: "Terkirim" },
  "dash.ot.statusApproved":       { es: "Aprobado",              en: "Approved",            id: "Disetujui" },
  "dash.ot.statusRejected":       { es: "Rechazado",             en: "Rejected",            id: "Ditolak" },
  "dash.ot.statusDraft":          { es: "Borrador",              en: "Draft",               id: "Draf" },
  "dash.ot.authorizerName":             { es: "Quien Autoriza",         en: "Authorizer",              id: "Yang Memberi Perintah" },
  "dash.ot.authorizerPlaceholder":      { es: "Nombre completo",        en: "Full name",               id: "Nama lengkap" },
  "dash.ot.position":                   { es: "Cargo / Posición",       en: "Position / Title",        id: "Jabatan" },
  "dash.ot.positionPlaceholder":        { es: "Ej: Jefe de Área",       en: "e.g. Department Head",    id: "cth: Kepala Bagian" },
  "dash.ot.reviewerName":               { es: "Visto Bueno / Aprobado", en: "Reviewer / Approved",     id: "Mengetahui/Menyetujui" },
  "dash.ot.reviewerPlaceholder":        { es: "Nombre completo",        en: "Full name",               id: "Nama lengkap" },
  "dash.ot.reviewerSubtitle":           { es: "Subtítulo",              en: "Subtitle",                id: "Keterangan Jabatan" },
  "dash.ot.reviewerSubtitlePlaceholder":{ es: "Ej: Kepala Cabang",      en: "e.g. Branch Manager",     id: "cth: Kepala Cabang" },
  "dash.ot.employee":                   { es: "Empleado",               en: "Employee",                id: "Yang Melaksanakan" },
  "dash.ot.btnApprove":                 { es: "Aprobar",                en: "Approve",                 id: "Setujui" },
  "dash.ot.btnReject":                  { es: "Rechazar",               en: "Reject",                  id: "Tolak" },
  "dash.ot.rejectPrompt":               { es: "Motivo del rechazo (opcional):", en: "Reason for rejection (optional):", id: "Alasan penolakan (opsional):" },
  ...
  "portal.title":              { es: "Portal de Horas Extras",    en: "Overtime Portal",          id: "Portal Lembur" },
  "portal.subtitle":           { es: "Ingresa con tu correo y contraseña para ver y reportar tus horas extras del mes.", en: "Log in with your email and password to view and report your overtime for the month.", id: "Masuk dengan email dan kata sandi untuk melihat dan melaporkan lembur bulan ini." },
  "portal.email":              { es: "Correo",                    en: "Email",                    id: "Email" },
  "portal.password":           { es: "Contraseña",                en: "Password",                 id: "Kata sandi" },
  "portal.loginBtn":           { es: "Ingresar",                  en: "Log in",                   id: "Masuk" },
  "portal.logout":             { es: "Salir",                     en: "Log out",                  id: "Keluar" },
  "portal.infoName":           { es: "Nombre",                    en: "Name",                     id: "Nama" },
  "portal.infoDept":           { es: "Departamento",              en: "Department",               id: "Departemen" },
  "portal.infoSalary":         { es: "Sueldo Básico",             en: "Base Salary",              id: "Gaji Pokok" },
  "portal.infoMaxOT":          { es: "Máximo Permitido",          en: "Maximum Allowed",          id: "Maksimum Diizinkan" },
  "portal.sessionsTitle":      { es: "Sesiones de Horas Extras",  en: "Overtime Sessions",        id: "Sesi Lembur" },
  "portal.addRow":             { es: "+ Agregar fila",            en: "+ Add row",                id: "+ Tambah baris" },
  "portal.thDate":             { es: "Fecha",                     en: "Date",                     id: "Tanggal" },
  "portal.thSchedule":         { es: "Horario",                   en: "Schedule",                 id: "Jadwal" },
  "portal.thHours":            { es: "Horas",                     en: "Hours",                    id: "Jam" },
  "portal.thType":             { es: "Tipo",                      en: "Type",                     id: "Tipe" },
  "portal.thDesc":             { es: "Descripción / Keterangan",  en: "Description / Keterangan", id: "Keterangan / Descripción" },
  "portal.typeWeekday":        { es: "Día hábil",                 en: "Weekday",                  id: "Hari kerja" },
  "portal.typeHoliday":        { es: "Día libre",                 en: "Day off / Holiday",        id: "Hari libur" },
  "portal.descPlaceholder":    { es: "Descripción del trabajo realizado…", en: "Description of work done…", id: "Keterangan pekerjaan yang dilakukan…" },
  "portal.noSessions":         { es: "No se encontraron sesiones de horas extras en este mes desde la app.", en: "No overtime sessions found for this month from the app.", id: "Tidak ada sesi lembur ditemukan bulan ini dari aplikasi." },
  "portal.noSessionsHint":     { es: "Verifica que el mes seleccionado sea correcto, o añade filas manualmente.", en: "Check that the selected month is correct, or add rows manually.", id: "Periksa bulan yang dipilih sudah benar, atau tambahkan baris secara manual." },
  "portal.calcTitle":          { es: "Cálculo de Remuneración",   en: "Pay Calculation",          id: "Perhitungan Upah" },
  "portal.calcWeekday":        { es: "Días hábiles:",             en: "Weekdays:",                id: "Hari kerja:" },
  "portal.calcHoliday":        { es: "Días libres / festivos:",   en: "Days off / holidays:",     id: "Hari libur / festif:" },
  "portal.calcTotal":          { es: "Horas extras solicitadas",  en: "Overtime requested",       id: "Lembur yang diminta" },
  "portal.overMax":            { es: "⚠ El total ({total}) supera el máximo permitido ({max}, {pct}% del sueldo).", en: "⚠ Total ({total}) exceeds the maximum allowed ({max}, {pct}% of salary).", id: "⚠ Total ({total}) melebihi maksimum ({max}, {pct}% dari gaji)." },
  "portal.btnSave":            { es: "Guardar borrador",          en: "Save draft",               id: "Simpan draf" },
  "portal.btnSubmit":          { es: "Enviar formulario",         en: "Submit form",              id: "Kirim formulir" },
  "portal.btnSubmitted":       { es: "✓ Enviado",                 en: "✓ Submitted",              id: "✓ Terkirim" },
  "portal.btnPrint":           { es: "🖨 Imprimir",               en: "🖨 Print",                  id: "🖨 Cetak" },
  "portal.confirmSubmit":      { es: "¿Confirmas el envío? El administrador podrá revisar el formulario.", en: "Confirm submission? The administrator will review the form.", id: "Konfirmasi pengiriman? Administrator akan meninjau formulir." },
  "portal.saving":             { es: "Guardando…",                en: "Saving…",                  id: "Menyimpan…" },
  "portal.savedDraft":         { es: "✓ Borrador guardado",       en: "✓ Draft saved",            id: "✓ Draf disimpan" },
  "portal.savedSubmitted":     { es: "✓ Formulario enviado",      en: "✓ Form submitted",         id: "✓ Formulir terkirim" },
  "portal.errProfile":         { es: "No se pudo cargar tu perfil. Contacta al administrador.", en: "Couldn't load your profile. Contact the administrator.", id: "Gagal memuat profil. Hubungi administrator." },
  "portal.errEmpOnly":         { es: "Este portal es exclusivo para empleados. Inicia sesión con tu cuenta de empleado.", en: "This portal is for employees only. Log in with your employee account.", id: "Portal ini hanya untuk karyawan. Masuk dengan akun karyawanmu." },
  "portal.printTitle":         { es: "FORMULARIO DE CÁLCULO DE HORAS EXTRAS", en: "OVERTIME CALCULATION FORM", id: "FORMULIR PERHITUNGAN KERJA LEMBUR" },
  "portal.printFormHeader":    { es: "Formulario de Cálculo de Horas Extras", en: "Overtime Calculation Form", id: "Formulir Perhitungan Lembur" },
  "portal.printName":          { es: "Nombre:",                   en: "Name:",                    id: "Nama:" },
  "portal.printDept":          { es: "Departamento:",             en: "Department:",              id: "Departemen:" },
  "portal.printSalary":        { es: "Sueldo Básico:",            en: "Base Salary:",             id: "Gaji Pokok:" },
  "portal.printMaxOT":         { es: "Máximo horas extras permitido ({pct}%) = {cur} {max}", en: "Maximum overtime allowed ({pct}%) = {cur} {max}", id: "Maksimum lembur diizinkan ({pct}%) = {cur} {max}" },
  "portal.printThDate":        { es: "Fecha",                     en: "Date",                     id: "Tanggal" },
  "portal.printThSchedule":    { es: "Horario",                   en: "Schedule",                 id: "Jadwal" },
  "portal.printThHours":       { es: "Horas",                     en: "Hours",                    id: "Jam" },
  "portal.printThWeekday":     { es: "Día Hábil",                 en: "Weekday",                  id: "Hari Kerja" },
  "portal.printThHoliday":     { es: "Día Libre",                 en: "Day Off",                  id: "Hari Libur" },
  "portal.printThDesc":        { es: "Descripción",               en: "Description",              id: "Keterangan" },
  "portal.printTotalHours":    { es: "Total Horas",               en: "Total Hours",              id: "Total Jam" },
  "portal.printCalcTitle":     { es: "Cálculo de Remuneración",   en: "Pay Calculation",          id: "Perhitungan Upah" },
  "portal.printCalcWeekday":   { es: "Días hábiles:",             en: "Weekdays:",                id: "Hari kerja:" },
